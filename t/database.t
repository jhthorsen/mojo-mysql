...
is_deeply $mysql->options, {use_dbi => 1, found_rows => 1, utf8 => 1, PrintError => 0}, 'right options';
...
$mysql = Mojo::mysql->new('mysql://x1:y2@%2ftmp%2fmysql.sock/test4?PrintError=1');
...
is_deeply $mysql->options, {use_dbi => 1, found_rows => 1, utf8 => 1, PrintError => 1}, 'right options';

# Connection string with lots of zeros
$mysql = Mojo::mysql->new('mysql://0:0@/0?use_dbi=0');
is $mysql->dsn,      'dbi:mysql:dbname=0', 'right data source';
is $mysql->username, '0',                  'right username';
is $mysql->password, '0',                  'right password';
is_deeply $mysql->options, {use_dbi => 0, found_rows => 1, utf8 => 1, PrintError => 0}, 'right options';
