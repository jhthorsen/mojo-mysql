...
$mysql = Mojo::mysql->new('mysql://?PrintError=1');
is $mysql->dsn,      'dbi:mysql:dbname=',  'right data source';
is $mysql->username, '',                   'no username';
is $mysql->password, '',                   'no password';
$options = {
  utf8 => 1,
...
is $mysql->dsn, 'dbi:mysql:dbname=test2;host=127.0.0.1;port=8080',
  'right data source';
is $mysql->username, '', 'no username';
is $mysql->password, '', 'no password';
$options = {
...
$mysql = Mojo::mysql->new('mysql://0:0@/0?PrintError=1');
