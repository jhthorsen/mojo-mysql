...
Mojo::mysql::Native::Results - Results

=head1 SYNOPSIS

  use Mojo::mysql::Native::Results;

  my $results = Mojo::mysql::Native::Results->new(db => $db);

=head1 DESCRIPTION

L<Mojo::mysql::Native::Results> is a container for results returned by call to
$db->L<Mojo::mysql::Native::Database/"query">.

=head1 METHODS

L<Mojo::mysql::Native::Results> inherits all methods from L<Mojo::mysql::Results> and implements
the following ones.
